<?php
    ...
    if( $record_number == 1 ){
        ...
        // VALUES ('".$_SESSION['TCAS_round']."','".$_POST['th_prefix']."','".$_POST['th_firstname']."','".$_POST['th_lastname']."','".$_POST['en_prefix']."','".$_POST['en_firstname']."','".$_POST['en_lastname']."','".$_POST['app_birthday']."','".$_POST['ethnicity']."','".$_POST['nationality']."','".$selected_religion."','".$_POST['Address']."','".$_POST['street']."','".$_POST['Province']."','".$_POST['District']."','".$_POST['sub_District']."','".$_POST['zipcode']."','".$_POST['Telephone']."','".$_POST['Email']."','".$_SESSION['new_national_id']."') ";
